...
public class WallPostImpl implements WallPost {
	...
	private static final Logger modelLogger = Logger.getLogger("ar.edu.unlp.oo1.ejercicio1.impl.model");
	...
	public void like() {
		...
		if (this.likes > 10) {
			modelLogger.warning("El post \"" + this.text + "\" tiene más de 10 likes");
		}
	}
	...
	public void dislike() {
		if (likes > 0) {
			this.likes = this.likes - 1;
			if(this.likes == 0) {
				modelLogger.warning("El post \"" + this.text + "\" tiene 0 likes");
			}
		}
