...
public class WallPostUI {
  ...
  private static final Logger uiLogger = Logger.getLogger("ar.edu.unlp.oo1.ejercicio1.ui");
  ...
  private void wireComponents() {
    this.like.addActionListener( e -> {
      ...
      uiLogger.info("Click en Like. Likes actuales: " + this.wallPost.getLikes());
    });
    
    this.dislike.addActionListener( e -> {
      this.wallPost.dislike();
      this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
      uiLogger.info("Click en Dislike. Likes actuales: " + this.wallPost.getLikes());
    });
    
    this.featuredCheckbox.addActionListener(e -> {
      this.wallPost.toggleFeatured();
      uiLogger.info("Click en Featured. Estado: " + this.wallPost.isFeatured());
    });
